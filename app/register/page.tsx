    ...
    <section className="mx-auto max-w-md">
      <div className="rounded-xl border-2 border-charcoal bg-white p-8 shadow-retro">
        ...
        <p className="mt-2 text-sm font-medium text-charcoal/80">
          Sign up with your email and password to start tracking.
        </p>

        {status === "success" ? (
          <div className="mt-6 border-2 border-charcoal bg-emerald-200 p-4 text-center text-sm font-medium text-charcoal">
